        ...
        <div className="space-y-1">
          {chatsData && (
            <div className="flex items-center justify-between gap-4">
              ...
              <span className="font-semibold text-gray-900 dark:text-gray-100">{chatsData.value}</span>
            </div>
          )}
          {messagesData && (
            <div className="flex items-center justify-between gap-4">
              ...
              <span className="font-semibold text-gray-900 dark:text-gray-100">{messagesData.value}</span>
            </div>
          )}
          {chatsData && messagesData && chatsData.value > 0 && (
            <div className="pt-2 mt-2 border-t border-gray-100 dark:border-gray-700">
              <div className="flex items-center justify-between gap-4">
                <span className="text-xs text-gray-500 dark:text-gray-400">Avg messages/chat</span>
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Usage Over Time</h2>
